...
import org.task.manager.config.ApplicationProperties

@SpringBootApplication
@EnableConfigurationProperties(LiquibaseProperties::class, ApplicationProperties::class)
class ToDoTaskManagerApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes ToDoTaskManager.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ToDoTaskManagerApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ToDoTaskManagerApp::class.java)
