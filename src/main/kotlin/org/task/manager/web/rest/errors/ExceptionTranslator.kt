package org.task.manager.web.rest.errors
...
class ExceptionTranslator : ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    fun handleEmailAlreadyUsedException(ex: org.task.manager.service.EmailAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    @ExceptionHandler
    fun handleUsernameAlreadyUsedException(ex: org.task.manager.service.UsernameAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
        val problem = LoginAlreadyUsedException()
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName, true, problem.entityName, problem.errorKey, problem.message))
    }

    @ExceptionHandler
    fun handleInvalidPasswordException(ex: org.task.manager.service.InvalidPasswordException, request: NativeWebRequest): ResponseEntity<Problem>? {
